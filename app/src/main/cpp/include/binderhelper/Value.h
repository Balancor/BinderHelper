...
#include <binderhelper/PersistableBundle.h>
#include <utils/Map.h>
...
public:
    ...
    Value(const PersistableBundle& value);
    Value(const Map& value);
    ...
    Value& operator=(const PersistableBundle& rhs);
    Value& operator=(const Map& rhs);
    ...
    void putPersistableBundle(const PersistableBundle& value);
    void putMap(const Map& value);
    ...
    bool getPersistableBundle(PersistableBundle* out) const;
    bool getMap(Map* out) const;
