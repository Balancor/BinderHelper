...
#include <binderhelper/native_handle.h>
...
#include <binderhelper/Parcelable.h>
#include <utils/Map.h>
...
public:
    ...
    status_t            writeValue(const Value& value);
    ...
    status_t            writeMap(const Map& map);
    status_t            writeNullableMap(const std::unique_ptr<Map>& map);
    ...
    status_t            readValue(Value* value) const;
    ...
    status_t            readMap(Map* map)const;
    status_t            readNullableMap(std::unique_ptr<Map>* map) const;
...
void flatten_binder(const sp<BinderHelper>& proc,
